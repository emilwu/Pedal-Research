...
| **Web-Service** | Web 產品程式碼：Next.js + Lambda | `/Users/emilwu/VSCode/PedalGuy/Pedal-Web-Service/` |
| **Web-Agent** | Web Agent 控制系統：指令路由、規則 | `/Users/emilwu/VSCode/PedalGuy/Pedal-Web-Service-agent/` |
| **App** | APP 產品程式碼 | `/Users/emilwu/VSCode/PedalGuy/Pedal-App/` |
| **App-Agent** | APP Agent 控制系統 | `/Users/emilwu/VSCode/PedalGuy/Pedal-App-agent/` |
...
2. 若要進行 Web Service 開發，請切換到 Agent 控制系統：
   `/Users/emilwu/VSCode/PedalGuy/Pedal-Web-Service-agent/CLAUDE.md`
